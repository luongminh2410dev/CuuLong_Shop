...
export const LEASING_PARTNERS: LeasingPartner[] = [
  {
    ...
    description:
      "Tập đoàn cho thuê tài chính hàng đầu khu vực với quy trình nhanh gọn và hạn mức cao.",
    highlights: [
      "Hỗ trợ lên đến 90%",
      "Thời hạn vay 5 năm",
      "Lãi suất cạnh tranh",
  ...
  },
  {
    ...
    description:
      "Thành viên của ngân hàng ACB, cung cấp giải pháp tài chính an toàn và bền vững.",
  ...
  },
  {
    ...
    description:
      "Đối tác tin cậy cho các doanh nghiệp xây dựng và khai khoáng tại Việt Nam.",
